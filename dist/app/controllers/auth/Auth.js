...
module.exports = /** @class */ (function (_super) {
    ...
    function Auth() {
         ...
         * @returns Response
         */
        _this.getAuthenticate = function () {
            return _this.route("get", "/login/", _this.getAuthLoginMiddleware(), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.postAuthenticate = function () {
            return _this.route("post", "/login/", _this.validatedLogin(), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                var errors, email, password, forgot_password, fetchUserEmail, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!req.isPost()) {
                            ...
                            if (!this._.isEmpty(forgot_password)) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.user.get({ email: email })];
                        case 2:
                            fetchUserEmail = _a.sent();
                            if (this._.isEmpty(fetchUserEmail)) {
                                req.setProp("error", "Email or password are not correct!, Please insert a valid data or sign up!");
                                return [2 /*return*/, this.redirect(res, "/login")];
                            }
                            return [3 /*break*/, 4];
                        case 3:
                            error_1 = _a.sent();
         ...
         * @returns Response
         */
        _this.getSignUp = function () {
            return _this.route("get", "/signup/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!req.isGet()) {
                        return [2 /*return*/, this.siteNotFound(res)];
                    }
         ...
         * @returns Response
         */
        _this.postSignUp = function () {
            return _this.route("post", "/signup/", _this.validatedSignUp(), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.logout = function () {
            return _this.route("post", "/logout/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    if (!req.isPost()) {
                        return [2 /*return*/, this.siteNotFound(res)];
         ...
         * @returns Response
         */
        _this.postReset = function () {
            return _this.route("post", "/reset/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                var email;
                var _this = this;
                return __generator(this, function (_a) {
                    if (!req.isPost()) {
         ...
         * @returns Response
         */
        _this.getReset = function () {
            return _this.route("get", "/reset/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (req.isGet()) {
                        res.noCacheNeeded();
         ...
         * @returns Response
         */
        _this.getRecoverPassword = function () {
            return _this.route("get", "/password_recovery/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (Object.keys(params).length > 0) {
                        first_question =
                            typeof params.security_questions !== "undefined"
                                ? params.security_questions[0]
                                    ? params.security_questions[0]
                                    : ""
                                : "";
                        second_question =
                            typeof params.security_questions !== "undefined"
                                ? params.security_questions[1]
                                    ? params.security_questions[1]
                                    : ""
                                : "";
         ...
         * @returns Response
         */
        _this.postRecoverPassword = function () {
            return _this.route("post", "/password_recovery/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    if (typeof req.getFormPostedData("security_questions") !== "object" ||
                        this._.isEmpty(req.getFormPostedData("first_answer")) ||
                        this._.isEmpty(req.getFormPostedData("second_answer"))) {
                        req.setProp("warning", "Please choose and answer the questions that you have submitted in order to recover your email!");
                        req.setProp("postData", req.getAllFormPostedData());
                            ...
                            if (result) {
                                ...
                                _this.user_security_questions
                                    ...
                                    if (result) {
                                        ...
                                        if (_first_answer === first_answer && _second_answer === second_answer) {
         ...
         * @returns Response
         */
        _this.getSecurityQuestions = function () {
            return _this.route("get", "/security/", { isAuth: isUserAuthenticated_1.default, userSession: initUserSession_1.default }, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    second_answer = null;
                    if (Object.keys(params).length > 0) {
                        first_question = params["security_questions"]
                            ? params.security_questions[0]
                                ? params.security_questions[0]
                                : ""
                            : "";
                        second_question = params["security_questions"]
                            ? params.security_questions[1]
                                ? params.security_questions[1]
                                : ""
                            : "";
                        ...
                        this.user_security_questions
                            .filter({ id: req.getCurrentUser().id })
                            .then(function (result) {
                            if (result) {
                                    ...
                                    if (typeof questions !== "undefined") {
                                        return _this.render(res, "shop/security", {
                                            ...
                                            first_question: first_question
                                                ? questions[first_question - 1].question
                                                : "",
                                            first_question_id: first_question
                                                ? questions[first_question - 1].id
                                                : "",
                                            second_question: second_question
                                                ? questions[second_question - 1].question
                                                : "",
                                            second_question_id: second_question
                                                ? questions[second_question - 1].id
                                                : "",
                                            first_answer: first_answer || "",
                                            second_answer: second_answer || ""
                                        });
         ...
         * @returns Response
         */
        _this.postSecurityQuestions = function () {
            return _this.route("post", "/security/", { isAuth: isUserAuthenticated_1.default, userSession: initUserSession_1.default }, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
         ...
         * @returns Response
         */
        _this.getPasswordReset = function () {
            return _this.route("get", "/password_reset/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
         ...
         * @returns Response
         */
        _this.postPasswordReset = function () {
            return _this.route("post", "/password_reset/", {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (this._.isEmpty(password) || this._.isEmpty(confirm_password)) {
                    ...
                    this.user
                        ...
                        if (rows) {
                            ...
                            bcryptjs_1.default
                                ...
                                .then(function (hashed_password) {
                                _this.user
                                    .update({ password: hashed_password }, rows.id)
                                    .then(function (result) {
                                    if (result) {
        ...
        _this.getAuthLoginMiddleware = function () { return ({
            cors: _this.express.expressCors(_this.corsOptionsDelegate)
        }); };
        //******************************\\
        //* Sign up middleware         *\\
        //******************************\\
        _this.validatedSignUp = function () { return ({
            ...
            validate_password: (0, express_validator_1.check)("password")
                ...
                .bail(),
            validate_confirm_password: (0, express_validator_1.check)("confirm_password")
