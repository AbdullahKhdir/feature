...
module.exports = /** @class */ (function (_super) {
    __extends(InteractiveChart, _super);
    function InteractiveChart() {
         ...
         * @returns Response
         */
        _this.interactiveChart = function () {
            return _this.route("get", "/interactive-charts/", _this.interactiveChartMiddleware(), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    ...
    //? SHOULD BE PROTECTED       ?\\
    //* ************************* *\\
    InteractiveChart.prototype.interactiveChartMiddleware = function () {
        return {
