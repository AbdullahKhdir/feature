...
module.exports = /** @class */ (function () {
        ...
        this.constants = {
            ...
            EXPRESS: {
                ...
                SESSION_OPTIONS: {
                    ...
                    cookie: {
                        maxAge: config.configurations().environment === "production"
    ...
    Constants.prototype.addHttpsMethods = function (methods) {
        ...
        if (typeof methods === "string") {
            ...
            methods.forEach(function (method) {
                _this.constants.CSRF.methods.push(method);
            });
            return true;
        }
        return false;
    ...
    Constants.prototype.removeHttpsMethods = function (methods) {
        ...
        if (typeof methods[Symbol.iterator] === "function") {
            methods.forEach(function (method) {
                _this.constants.CSRF.methods = _this.constants.CSRF.methods.filter(function (http_method) {
