...
module.exports = /** @class */ (function () {
        ...
        this.constants = {
            ...
            EXPRESS: {
                ...
                SESSION_OPTIONS: {
                    ...
                    cookie: {
                        maxAge: config.configurations().environment === 'production' ? 1000 * 60 * 60 * 1 : 1000 * 60 * 60 * 6,
                        secure: true,
                        httpOnly: true
                    }
                }
            ...
            SITE_DOMAIN_AND_PORT: config.configurations().domain_name,
            SESSION: {
                DB_CONNECTION_SESSION_TIME_OUT: config.configurations().environment === 'production' ? 1000 * 60 * 60 * 1 : 1000 * 60 * 60 * 6,
                DB_CONNECTION_SESSION_EXPIRATION_INTERVAL: config.configurations().environment === 'production' ? 1000 * 60 * 60 * 1 : 1000 * 60 * 60 * 6,
            ...
            I18N: {
                CONFIGURATION_OPTIONS: {
                    ...
                    directory: Singleton_1.Singleton.getPath().join(__dirname, '..', '..', '..', 'src', 'app', 'dictionaries'),
     ...
     * @returns object
    */
    Constants.getConstantsInstance = function () {
    ...
    Object.defineProperty(Constants.prototype, "getConstants", {
        /**
    ...
    */
    Constants.prototype.addOneConstant = function (key, value) {
        // @ts-ignore 
     ...
     * @returns array|object
    */
    Constants.prototype.addObjectConstant = function () {
        var object = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            object[_i] = arguments[_i];
        }
        return this.constants = Object.assign.apply(Object, __spreadArray([this.constants], object, false));
    };
    /**
     ...
     * @returns boolean
    */
    Constants.prototype.clearConstants = function () {
        // @ts-ignore 
        this.constants = {};
        return !this.constants;
    };
