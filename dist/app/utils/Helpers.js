...
exports.validURL = exports.validatePhoneNumber = exports.validateDomain = exports.validateEmail = exports.is_a = exports.get_class = exports._inArray = exports.shuffleArray = exports.getUnique = exports.scrollToBottom = exports.scrollToTop = exports.isDarkMode = void 0;
/**
 * @function isDarkMode
...
var is_a = function (obj, className) {
    className = className.replace(/[^\w\$_]+/, "");
    // @ts-ignore 
    return (0, exports.get_class)(obj) === className && { function: 1 }[eval("typeof(".concat(className, ")"))] && obj instanceof eval(className);
};
exports.is_a = is_a;
