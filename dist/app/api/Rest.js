...
module.exports = /** @class */ (function (_super) {
    ...
    function Rest() {
         ...
         * @returns Response
        */
        _this.getExmaple = function () { return _this.route('get', '/rest/get_exmaple', {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
         ...
         * @returns Response
        */
        _this.postExmaple = function () { return _this.route('post', '/rest/get_exmaple', {}, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new JsonResponse_1.default(201, 'Success', { success: 'OK', id: new Date().getTimezoneOffset() }).sendAsJson(res)];
            });
        }); }); };
        //? ************************************************************** ?\\
    ...
    Rest.prototype.firstDynMethodMiddleware = function () {
        return {
