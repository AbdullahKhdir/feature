...
var lodash_1 = __importDefault(require("lodash")); // Lodash import
module.exports = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Db.prototype, "getMysqlStore", {
        /**
     ...
     * @returns {mysql.Pool}
     */
    Db.prototype.establishConnectionWithoutDb = function () {
        var pool = this.mysql2.createPool(lodash_1.default.pickBy({
    ...
    /**
     * @function establishConnectionWithDb
     * @description Creates the database connection pool to the database after it has been created.
     * @returns {mysql.Pool}
     */
    Db.prototype.establishConnectionWithDb = function () {
        if (!this.pool) {
            this.pool = this.mysql2.createPool(lodash_1.default.pickBy({
                host: config.configurations().host,
                port: config.configurations().port,
                user: config.configurations().user,
                password: config.configurations().password,
    ...
    Db.prototype.query = function (sql, arr) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var pool, _a, result, fields;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        pool = this.establishConnectionWithDb();
                        return [4 /*yield*/, pool.query(sql, arr)];
                    case 1:
                        _a = _b.sent(), result = _a[0], fields = _a[1];
                        // Type narrowing for different result sets
                        if (lodash_1.default.isArray(result) && lodash_1.default.isArray(result[0])) {
                            return [2 /*return*/, [result[0], fields]]; // Return the first result set if it's a multi-result query
                        }
                        else {
     ...
     * @param {any[]} arr - The query parameters (optional)
     * @returns {Promise<[T, FieldPacket[]]>}
     */
     ...
     * @description Validates if a table exists in the database
    ...
    Db.prototype.describeTable = function (table) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.executeModelQuery("DESC ".concat(table, ";"))];
            });
        });
    };
    /**
    ...
    Db.prototype.readMigrations = function () {
        return __awaiter(this, void 0, void 0, function () {
            var path, fileSystem, directoryRoutes, dbName, migrationTable, sqlCheckDatabase, createDatabaseSql, checkMigrationsTableSql, colorLog, handleError, promptUserForDatabaseCreation, processMigrations, pool, connection, rows, dbPool, dbConnection, migrationRows, createMigrationTable, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                                ...
                                return [2 /*return*/, new Promise(function (resolve, reject) {
                                        promptUser.question(question, function (answer) { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        if (!lodash_1.default.includes(["Y", "y"], answer.trim())) return [3 /*break*/, 5];
                                                    ...
                                                    case 3:
                                                        error_2 = _a.sent();
                                                        handleError("Database \"".concat(dbName, "\" could not be created!"), error_2);
                                                        promptUser.close();
                                                        reject(error_2);
                                                        return [3 /*break*/, 4];
                        ...
                        processMigrations = function (connection, directory, fs) { return __awaiter(_this, void 0, void 0, function () {
                            var files, _i, files_1, file, migrationName, sqlMigrationPath, sqlContent, rows, insertMigrationSql, error_3;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 3:
                                        rows = (_a.sent())[0];
                                        if (!lodash_1.default.isEmpty(rows)) return [3 /*break*/, 6];
                                    ...
                                    case 8:
                                        error_3 = _a.sent();
                                        handleError("Error processing migration: ".concat(migrationName), error_3);
                                        return [3 /*break*/, 9];
                                    case 9:
                                        _i++;
                                        return [3 /*break*/, 1];
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        dbPool = this.establishConnectionWithDb();
                    ...
                    case 9:
                        ...
                        if (!lodash_1.default.isEmpty(migrationRows)) return [3 /*break*/, 11];
                    ...
                    case 18:
                        error_1 = _a.sent();
                        handleError("Error while executing migration process", error_1);
                        return [3 /*break*/, 19];
