...
module.exports = /** @class */ (function (_super) {
    __extends(SQLException, _super);
    function SQLException(message, statusCode) {
        if (message === void 0) { message = ""; }
        if (statusCode === void 0) { statusCode = Singleton_1.Singleton.getConstants().HTTPS_STATUS.SERVER_ERRORS.INTERNAL_SERVER_ERROR; }
        var _this = _super.call(this, "SQLException", message, statusCode) || this;
        Object.setPrototypeOf(_this, SQLException.prototype);
        return _this;
    }
    return SQLException;
