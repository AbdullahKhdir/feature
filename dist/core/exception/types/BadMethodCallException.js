...
module.exports = /** @class */ (function (_super) {
    ...
    function BadMethodCallException(message, statusCode) {
        if (message === void 0) { message = ""; }
        if (statusCode === void 0) { statusCode = Singleton_1.Singleton.getConstants().HTTPS_STATUS.CLIENT_ERRORS.BAD_REQUEST; }
        var _this = _super.call(this, "BadMethodCallException", message, statusCode) || this;
        Object.setPrototypeOf(_this, BadMethodCallException.prototype);
        return _this;
    }
