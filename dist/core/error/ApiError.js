...
module.exports = /** @class */ (function (_super) {
    ...
    function ApiError(name, message, status_code) {
    ...
    ApiError.errorHandler = function (error) {
        ...
        return _a = {},
            ...
            _a[SERVER.INTERNAL_SERVER_ERROR] = {
                ...
                status_description: _.capitalize(error.message || "Please contact the support team!") ||
                    "Please contact the support team!",
                url: !error.message ? "mailto:".concat(config.configurations().supportTeamEmail) : "/",
