...
function default_1(execution) {
    return function (req, res, next) {
        ...
        if (typeof res !== 'undefined') {
            ...
            * @return void
            */
            res.setCookie = function (object, expires, domain, path, secure, http_only, same_site) {
                ...
                if (typeof object === 'string') {
                    ...
                    res.cookie(_key_1, _value_1, options);
                }
                ...
                * @return void
                */
                res.onLogOut = function (name, options) {
                ...
                * @return void
                */
                res.storeInPrivateCache = function () {
                ...
                */
                res.longTimeNoCache = function () {
                    ...
                    */
                    var store_cache_privatly = res.storeInPrivateCache();
                ...
                * @return void
                */
                res.updatedContentAlways = function () {
                    /*
                ...
                * @return void
                */
                res.cacheLastResOnErr = function () {
                    /*
