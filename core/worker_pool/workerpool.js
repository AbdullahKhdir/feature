...
module.exports = class Workerpool {
    ...
    #script = new Path().path.join(__dirname, '..', '..', 'app', 'worker', './pool_logic.js');
    #options = {
        minWorkers: 'max',
        workerType: 'auto'
    };
    constructor(script = this.#script, options = this.#options) {
    ...
    */   
    #isInitialized() {
        if (typeof this.worker_pool === 'object') {
            return this.worker_pool !== null
        }
        return !typeof this.worker_pool !== 'undefined';
    }
}