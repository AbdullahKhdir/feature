...
export = class Table extends BaseController{
     ...
     * @returns Response
    */
    table = () => this.route('get', '/fullscreen-table', {}, async (req: Request, res: Response, next: NextFunction) => {
        return this.render(
            res,
     ...
     * @returns Response
    */
    customTable = () => this.route('get', '/custom-table/', {}, async (req: Request, res: Response, next: NextFunction) => {
        return this.render(
            res,
