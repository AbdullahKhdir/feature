...
export = class Header extends BaseController {
     ...
     * @returns Response
    */
    tabbed = () => this.route('get', '/header-tabbed', this.tabbedMiddleware(), async (req: Request, res: Response, next: NextFunction) => {
        return this.render(
            res,
     ...
     * @returns Response
    */
    metrics = () => this.route('get', '/header-metrics', this.metricsMiddleware(), async (req: Request, res: Response, next: NextFunction) => {
        return this.render(
            res,
     ...
     * @returns Response
    */
    search = () => this.route('get', '/header-search/', this.searchMiddleware(), async (req: Request, res: Response, next: NextFunction) => {
        return this.render(
            res,
